...
export interface ConduitMockRevertBytesInterface extends utils.Interface {
  functions: {
...
export interface ConduitMockRevertBytes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConduitMockRevertBytesInterface;

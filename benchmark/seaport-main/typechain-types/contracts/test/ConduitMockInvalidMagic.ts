...
export interface ConduitMockInvalidMagicInterface extends utils.Interface {
  functions: {
...
export interface ConduitMockInvalidMagic extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConduitMockInvalidMagicInterface;

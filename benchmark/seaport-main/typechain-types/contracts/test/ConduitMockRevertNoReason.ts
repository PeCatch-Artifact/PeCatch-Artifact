...
export interface ConduitMockRevertNoReasonInterface extends utils.Interface {
  functions: {
...
export interface ConduitMockRevertNoReason extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConduitMockRevertNoReasonInterface;
